                    ...
                    <div className="flex flex-wrap justify-center">
                        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6   flex justify-center items-center">
                            <div className="text-center">
                                <h2 className="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">Misión</h2>
                                <p className="leading-relaxed text-base mb-4">Nos importa tu éxito académico. Esta plataforma fue diseñada para ayudarte a organizarte mejor y a lograr tus objetivos</p>
                            </div>
                        </div>
                        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60 flex justify-center items-center">
                            <div className="text-center">
                                <h2 className="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">Propósito del proyecto</h2>
                                <p className="leading-relaxed text-base mb-4">A través de esta herramienta, buscamos facilitarte el manejo de tus tareas y proyectos, mejorando tu organización y rendimiento académico.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="text-gray-600 body-font mb-32">
                <div className="container px-5 py-5  mx-auto">
                    <div className="flex flex-col text-center w-full mb-24">
                        <h1 className="text-[24px] sm:text-[42px] italic font-semibold text-center uppercase mb-8 text-[#1e293b]">Equipo de trabajo</h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Somos un grupo de estudiantes del programa de desarrollo web full stack nivel básico del Ministerio de Tecnología de Colombia. </p>
                    </div>
