...
function RegisterPage() {
    ...
    return (
        <div className="flex h-[calc(100vh-100px)] items-center justify-center">
            <div className='bg-[#abaeb8] max-w-md  p-10 rounded-md'>
                {
                ...
                <h1 className="text-3xl font-bold my-2 text-white text-center">Registrate</h1>
                < form onSubmit={onSubmit}>

                    <input type="text"
                        {...register("username", { required: true })}
                        className='w-full bg-white-700 text-blue px-4 py-2 rounded-md my-2'
                        placeholder='Username'
                    />
                    {errors.username && (<p className='text-red-500'>Usuario es necesario</p>)}
                    < input type="email"
